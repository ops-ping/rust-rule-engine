...
fn test_sequential(rules_str: &str, facts: &Facts) -> Result<std::time::Duration, Box<dyn std::error::Error>> {
...
fn test_parallel(rules_str: &str, facts: &Facts, threads: usize) -> Result<std::time::Duration, Box<dyn std::error::Error>> {
