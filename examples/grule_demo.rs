...
fn demo_engine_execution() -> std::result::Result<(), Box<dyn std::error::Error>> {
    ...
    let adult_rule = Rule::new(
        ...
        vec![
            ...
            ActionType::Call {
                ...
                args: vec![Value::String("User qualified as adult".to_string())],
            },
        ],
    )
    .with_salience(10);
    ...
    let vip_rule = Rule::new(
        ...
        vec![
            ...
            ActionType::Call {
                function: "log".to_string(),
                args: vec![Value::String("User upgraded to VIP".to_string())],
            },
        ],
    )
    .with_salience(20);
    ...
    let senior_rule = Rule::new(
        ...
        vec![
            ...
            ActionType::Call {
                function: "log".to_string(),
                args: vec![Value::String("Senior discount applied".to_string())],
            },
        ],
    )
    .with_salience(15);
...
fn demo_ecommerce_scenario() -> std::result::Result<(), Box<dyn std::error::Error>> {
    ...
    let new_customer_rule = Rule::new(
        ...
        vec![
            ...
            ActionType::Call {
                function: "log".to_string(),
                args: vec![Value::String("New customer discount applied".to_string())],
            },
        ],
    )
    .with_salience(10);
    ...
    let calculate_final_rule = Rule::new(
        ...
        vec![ActionType::Call {
            ...
            args: vec![Value::String(
                "Calculating final amount with discount".to_string(),
            )],
        }],
    )
    .with_salience(5);
