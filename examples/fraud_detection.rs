        ...
        vec![
            ActionType::Call {
                ...
                args: vec![Value::String(
                    "HIGH AMOUNT ALERT: Transaction exceeds daily limit".to_string(),
                )],
            },
    ...
    let foreign_location_rule = Rule::new(
        ...
        vec![
            ActionType::Call {
                function: "log".to_string(),
                args: vec![Value::String(
                    "LOCATION ALERT: Foreign transaction detected".to_string(),
                )],
            },
            ActionType::Call {
                function: "sum".to_string(),
                args: vec![
                    Value::String("Alert.FraudScore".to_string()),
                    Value::Number(30.0),
                ],
            },
        ],
    ...
    let late_night_rule = Rule::new(
        ...
        vec![
            ActionType::Call {
                function: "log".to_string(),
                args: vec![Value::String(
                    "TIME ALERT: Late night transaction".to_string(),
                )],
            },
            ActionType::MethodCall {
                object: "Alert".to_string(),
    ...
    let high_risk_merchant_rule = Rule::new(
        ...
        vec![
            ActionType::Call {
                function: "log".to_string(),
                args: vec![Value::String(
                    "MERCHANT ALERT: High-risk merchant category".to_string(),
                )],
            },
            ActionType::MethodCall {
                object: "Alert".to_string(),
    ...
    let critical_fraud_rule = Rule::new(
        ...
        vec![
            ActionType::Call {
                function: "log".to_string(),
                args: vec![Value::String(
                    "🚨 CRITICAL FRAUD ALERT! Blocking transaction!".to_string(),
                )],
            },
            ActionType::Set {
                field: "Alert.Status".to_string(),
            ...
            ActionType::Call {
                ...
                args: vec![
                    Value::String("Transaction #{0} BLOCKED - Fraud Score: {1}".to_string()),
                    Value::String("TX123456".to_string()),
                    Value::String("Alert.FraudScore".to_string()),
                ],
            },
        ],
    ...
    let insufficient_funds_rule = Rule::new(
        ...
        vec![
            ActionType::Call {
                function: "log".to_string(),
                args: vec![Value::String(
                    "💰 INSUFFICIENT FUNDS: Transaction declined".to_string(),
                )],
            },
            ActionType::Set {
                field: "Alert.Status".to_string(),
