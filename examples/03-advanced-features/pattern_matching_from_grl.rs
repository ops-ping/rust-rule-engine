...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Read GRL file
    let grl_content = fs::read_to_string("examples/rules/03-advanced/pattern_matching.grl")?;
    println!("📄 Reading rules from: examples/rules/03-advanced/pattern_matching.grl");
